 ...
 * @param {Object} ctx - Auth session context
 * @param {any} appState - additional app state to be stored in session
 * @param {Object} meta - metadata of the request
 * @param {storedCallback} cb - callback function to execute after storing session
 *
 * @public
 */
 ...
 * @param {Error} err - Error object if the store function encounters any error, null otherwise.
 ...
 * @param {verifyCallback} cb - callback function to execute after storing session
 *
 * @public
 */
 ...
 * @param {Error} err - Error object if the store function encounters any error, null otherwise.
 * @param {Object} ctx - Auth session context
 * @param {Object} state - Verified session state
 */
