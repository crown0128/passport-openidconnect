 ...
 * @param {function | boolean} [options.skipUserProfile] - determines if user data is loaded from /userInfo endpoint.
 * @param {VerifyFunction} verify
 * @see {@link VerifyFunction}
...
Strategy.prototype.authenticate = function (req, options) {
    ...
    if (req.query && req.query.code) {
        ...
        function restored(err, ctx, state) {
            ...
            if (state && self._pkce) {
                params.code_verifier = state.verifier;
            }
