...
describe("Strategy", function () {
    ...
    it("should authenticate request", function (done) {
        ...
        chai.passport
            ...
            .success(function (user, info) {
                ...
                expect(
                    strategy._oauth2.getOAuthAccessToken.calledOnce
                ).to.be.true;
                expect(
    ...
    it("should error when ID token is missing expiration time claim", function (done) {
        ...
        chai.passport
            ...
            .error(function (err) {
                expect(err).to.be.an.instanceof(Error);
                expect(err.message).to.equal(
                    "ID token missing expiration time claim"
                );
                done();
            })
            .authenticate();
    ...
    it("should error when ID token is missing issued at claim", function (done) {
        ...
        chai.passport
            ...
            .error(function (err) {
                expect(err).to.be.an.instanceof(Error);
                expect(err.message).to.equal(
                    "ID token missing issued at claim"
                );
                done();
            })
            .authenticate();
    ...
    it("should throw if constructed without a verify function", function () {
        expect(function () {
            ...
            TypeError,
            "OpenIDConnectStrategy requires a verify function"
        );
    });
    ...
    it("should throw if constructed without an issuer option", function () {
        expect(function () {
            ...
            TypeError,
            "OpenIDConnectStrategy requires an issuer option"
        );
    });
    ...
    it("should throw if constructed without a tokenURL option", function () {
        expect(function () {
            ...
            TypeError,
            "OpenIDConnectStrategy requires a tokenURL option"
        );
    });
    ...
    it("should throw if constructed without a clientID option", function () {
        expect(function () {
            ...
            TypeError,
            "OpenIDConnectStrategy requires a clientID option"
        );
    });
}); // Strategy
